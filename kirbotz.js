...
case 'pln':
if (args.length == 0) return  replyNya(` kirim nomor token ke MyOwner
v1
√ 20.000 🔋 : 22.000
√ 50.000 🔋 : 52.000
√ 100.000 🔋 : 102.000
...
case 'viig':
if (args.length == 0) return  replyNya(` kirim link ke MyOwner
v2
√ 1.000 💉 : 2.000
√ 2.000 💉 : 3.000
√ 5.000 💉 : 5.000
...
case 'ig':
if (args.length == 0) return  replyNya(` kirim nama/username ke MyOwner
v2
paket 1:
√ 1.000 💉 : 12.000
√ 2.000 💉 : 21.000
...
case 'pulsa':
if (args.length == 0) return  replyNya(` kirim nomer ke MyOwner
v2
√ 5000 : 6.900
√ 10000 : 11.900
√ 15000 : 16.900
...
case 'ff':
if (args.length == 0) return  replyNya(` kirim id ke MyOwner
...
case 'ml':
if (args.length == 0) return  replyNya(` kirim id+server ke MyOwner
